...
public class UserInterface {
	...
	JPanel startMenuPanel, primaryMainGamePanel, mainGamePanel1, mainGamePanel2, mainGamePanel3, internalPanel1, inventoryPanel,
	inventoryHeader, inventoryColumn1, inventoryColumn2, inventoryColumn3;
	JButton startButton,loadGameButton, inventoryButton, mapButton, exitButton, gPButton1, gPButton2, gPButton3, gPButton4;
	JLabel titleLabel, fillerLabelTop, fillerLabelMiddle, fillerLabelBottom, hPLabel, lastLocationLabel, currentLocationLabel,
	fillerLabel1, fillerLabel2, fillerLabel3, westFillerLabel, eastFillerLabel, notifictaionLabel1, gameTextLabel1, gameTextLabel2,
	gameTextLabel3, gameTextLabel4, gameTextLabel5, currentLocationNameLabel, lastLocationNameLabel;
	...
	public void createUserInterface(GeneralButtonHandler gButtonHandler, GameplayButtonHandler gPBHandler) {
		...
		primaryGameFrame.setTitle("Still Untitled");
		...
		titleLabel.setText("Still Untitled");
...
//		gBC.fill = GridBagConstraints.REMAINDER;
		...
		loadGameButton.setVisible(false); // Disabled until game save/load features are added
...
//		button1.setBorderPainted(false); // Removes the clicking animation - the thin white line around the box - leaving the box for now, it is confusing without it
		...
		inventoryButton.addActionListener(gButtonHandler);
		...
		// Creating lastLocationLabel
		lastLocationLabel = new JLabel();
		lastLocationLabel.setText("Last Location:");
		lastLocationLabel.setForeground(Color.WHITE);
		lastLocationLabel.setVerticalAlignment(JLabel.CENTER); // Centering the JLabel text in the vertical direction
		lastLocationLabel.setHorizontalAlignment(JLabel.LEFT); // Centering the JLabel text in the horizontal direction
		lastLocationLabel.setPreferredSize(new Dimension(150, 20) ); // This works for setting the size when it's container is using GridBagLayout and .pack()
		lastLocationLabel.setMaximumSize(new Dimension(150, 20) ); // I don't think this makes a difference or affects anything under the current setup
		// Creating currentLocaitonLabel
		...
		currentLocationLabel.setVerticalAlignment(JLabel.CENTER); // Centering the JLabel text in the vertical direction
		currentLocationLabel.setHorizontalAlignment(JLabel.LEFT); // Centering the JLabel text in the horizontal direction
		currentLocationLabel.setPreferredSize(new Dimension(150, 20) ); // This works for setting the size when it's container is using GridBagLayout and .pack()
		currentLocationLabel.setMaximumSize(new Dimension(150, 20) ); // I don't think this makes a difference or affects anything under the current setup
		// Creating lastLocationNameLabel
		lastLocationNameLabel = new JLabel();
		lastLocationNameLabel.setForeground(Color.WHITE);
		lastLocationNameLabel.setVerticalAlignment(JLabel.CENTER); // Centering the JLabel text in the vertical direction
		lastLocationNameLabel.setHorizontalAlignment(JLabel.LEFT); // Centering the JLabel text in the horizontal direction
		lastLocationNameLabel.setPreferredSize(new Dimension(150, 20) ); // This works for setting the size when it's container is using GridBagLayout and .pack()
		lastLocationNameLabel.setMaximumSize(new Dimension(150, 20) ); // I don't think this makes a difference or affects anything under the current setup
		// Creating currentLocaitonNameLabel
		currentLocationNameLabel = new JLabel();
		currentLocationNameLabel.setForeground(Color.WHITE);
		currentLocationNameLabel.setVerticalAlignment(JLabel.CENTER); // Centering the JLabel text in the vertical direction
		currentLocationNameLabel.setHorizontalAlignment(JLabel.LEFT); // Centering the JLabel text in the horizontal direction
		currentLocationNameLabel.setPreferredSize(new Dimension(150, 20) ); // This works for setting the size when it's container is using GridBagLayout and .pack()
		currentLocationNameLabel.setMaximumSize(new Dimension(150, 20) ); // I don't think this makes a difference or affects anything under the current setup
...
//		internalPanel1.setBorder(BorderFactory.createLineBorder(Color.GREEN, 3) );
		...
		// Adding lastLocationLabel to panel 2
		primaryGBC.gridx = 0;
		primaryGBC.gridy = 3;
		primaryGBC.anchor = GridBagConstraints.NORTH; // Tells the component to go to the top of the container - component must have it's fill set to NONE or it will fill the entire container - the weight of the component in the directon of alignment must be at least 1
		primaryGBC.fill = GridBagConstraints.NONE; // Tells the component not to resize to fill it's container
		mainGamePanel2.add(lastLocationLabel, primaryGBC);
		// Adding lastLocationNameLabel to panel 2
		primaryGBC.gridx = 0;
		primaryGBC.gridy = 4;
		primaryGBC.anchor = GridBagConstraints.NORTH; // Tells the component to go to the top of the container - component must have it's fill set to NONE or it will fill the entire container - the weight of the component in the directon of alignment must be at least 1
		primaryGBC.fill = GridBagConstraints.NONE; // Tells the component not to resize to fill it's container
		mainGamePanel2.add(lastLocationNameLabel, primaryGBC);
		// Adding currentLocationLabel to panel 2
		primaryGBC.gridx = 0;
		primaryGBC.gridy = 5;
		primaryGBC.anchor = GridBagConstraints.NORTH; // Tells the component to go to the top of the container - component must have it's fill set to NONE or it will fill the entire container - the weight of the component in the directon of alignment must be at least 1
		primaryGBC.fill = GridBagConstraints.NONE; // Tells the component not to resize to fill it's container
		mainGamePanel2.add(currentLocationLabel, primaryGBC);
		// Adding currentLocationNameLabel to panel 2
		primaryGBC.gridx = 0;
		primaryGBC.gridy = 6;
		primaryGBC.anchor = GridBagConstraints.NORTH; // Tells the component to go to the top of the container - component must have it's fill set to NONE or it will fill the entire container - the weight of the component in the directon of alignment must be at least 1
		primaryGBC.fill = GridBagConstraints.NONE; // Tells the component not to resize to fill it's container
		mainGamePanel2.add(currentLocationNameLabel, primaryGBC);
		// Adding filler label
		primaryGBC.gridx = 0;
		primaryGBC.gridy = 7;
...
//		primaryGBC.gridheight = 1;
		...
		inventoryHeader = new JPanel();
		inventoryColumn1 = new JPanel();
		inventoryColumn2 = new JPanel();
		inventoryColumn3 = new JPanel();
		// Adding inventoryPanel to primaryGamePanel
		inventoryPanel.setBackground(Color.YELLOW);
		inventoryPanel.setBorder(BorderFactory.createLineBorder(Color.GRAY, 1) ); // Adding a border to panel1 - this adds a border and sets the color and width of the border.
		primaryGBC.gridx = 1; // Setting the x-location of the panel1 object within the primaryPanel object
		primaryGBC.gridy = 1; // Setting the y-location of the panel1 object within the primaryPanel object
		primaryGBC.gridwidth = 1; // Setting the number of cells of the GBL grid in the x-direction that panel1 will take up
		primaryGBC.gridheight = 1; // Setting the number of cells of the GBL grid in the y-direction that panel1 will take up
		...
		primaryGBC.weighty = 1; // Still don't fully understand this line ************************
		primaryGBC.fill = GridBagConstraints.BOTH; // Setting the panel to expand in both the x and y-directions to fill any extra space in the parent/super-container
		primaryMainGamePanel.add(inventoryPanel, primaryGBC); 
		// Adding inventoryHeader to inventoryPanel
		inventoryHeader.setBackground(Color.BLUE);
		inventoryHeader.setBorder(BorderFactory.createLineBorder(Color.GRAY, 1) ); // Adding a border to panel1 - this adds a border and sets the color and width of the border.
		primaryGBC.gridx = 0; // Setting the x-location of the panel1 object within the primaryPanel object
		primaryGBC.gridy = 0; // Setting the y-location of the panel1 object within the primaryPanel object
		primaryGBC.gridwidth = 1; // Setting the number of cells of the GBL grid in the x-direction that panel1 will take up
		primaryGBC.gridheight = 1; // Setting the number of cells of the GBL grid in the y-direction that panel1 will take up
		primaryGBC.weightx = 1; // Still don't fully understand this line
		primaryGBC.weighty = 1; // Still don't fully understand this line ************************
		primaryGBC.fill = GridBagConstraints.BOTH; // Setting the panel to expand in both the x and y-directions to fill any extra space in the parent/super-container
		inventoryPanel.add(inventoryHeader, primaryGBC); 
		// Adding inventoryColumn1 to inventoryPanel
		inventoryColumn1.setBackground(Color.RED);
		inventoryColumn1.setBorder(BorderFactory.createLineBorder(Color.GRAY, 1) ); // Adding a border to panel1 - this adds a border and sets the color and width of the border.
		primaryGBC.gridx = 0; // Setting the x-location of the panel1 object within the primaryPanel object
		primaryGBC.gridy = 1; // Setting the y-location of the panel1 object within the primaryPanel object
		primaryGBC.gridwidth = 1; // Setting the number of cells of the GBL grid in the x-direction that panel1 will take up
		primaryGBC.gridheight = 1; // Setting the number of cells of the GBL grid in the y-direction that panel1 will take up
		...
		primaryGBC.weighty = 1; // Still don't fully understand this line ************************
		primaryGBC.fill = GridBagConstraints.BOTH; // Setting the panel to expand in both the x and y-directions to fill any extra space in the parent/super-container
		inventoryPanel.add(inventoryColumn1, primaryGBC);
		// Adding inventoryColumn2 to inventoryPanel
		inventoryColumn2.setBackground(Color.GREEN);
		inventoryColumn2.setBorder(BorderFactory.createLineBorder(Color.GRAY, 1) ); // Adding a border to panel1 - this adds a border and sets the color and width of the border.
		primaryGBC.gridx = 1; // Setting the x-location of the panel1 object within the primaryPanel object
		primaryGBC.gridy = 1; // Setting the y-location of the panel1 object within the primaryPanel object
		primaryGBC.gridwidth = 1; // Setting the number of cells of the GBL grid in the x-direction that panel1 will take up
		primaryGBC.gridheight = 1; // Setting the number of cells of the GBL grid in the y-direction that panel1 will take up
		...
		primaryGBC.weighty = 1; // Still don't fully understand this line ************************
		primaryGBC.fill = GridBagConstraints.BOTH; // Setting the panel to expand in both the x and y-directions to fill any extra space in the parent/super-container
		inventoryPanel.add(inventoryColumn2, primaryGBC);
		// Adding inventoryColumn3 to inventoryPanel
		inventoryColumn3.setBackground(Color.BLACK);
		inventoryColumn3.setBorder(BorderFactory.createLineBorder(Color.GRAY, 1) ); // Adding a border to panel1 - this adds a border and sets the color and width of the border.
		primaryGBC.gridx = 2; // Setting the x-location of the panel1 object within the primaryPanel object
		primaryGBC.gridy = 1; // Setting the y-location of the panel1 object within the primaryPanel object
		primaryGBC.gridwidth = 1; // Setting the number of cells of the GBL grid in the x-direction that panel1 will take up
		primaryGBC.gridheight = 1; // Setting the number of cells of the GBL grid in the y-direction that panel1 will take up
		primaryGBC.weightx = 1; // Still don't fully understand this line
		primaryGBC.weighty = 1; // Still don't fully understand this line ************************
		primaryGBC.fill = GridBagConstraints.BOTH; // Setting the panel to expand in both the x and y-directions to fill any extra space in the parent/super-container
		inventoryPanel.add(inventoryColumn3, primaryGBC);
